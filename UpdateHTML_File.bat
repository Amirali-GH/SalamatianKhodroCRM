...
set FILE_PATH=D:\MyProject\SalamatSaleDepartment\MainWebSite\WWW\index.html
set SERVER_USER=root
set SERVER_PASS=yeY92B9Zx3
set SERVER_IP=62.60.214.159
set REMOTE_PATH=/root/PAServer/scratch-dir/amira-AmirAli/Project.SalamatianCutomer/WWW/
