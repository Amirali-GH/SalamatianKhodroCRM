...
Type
    ...
    [MVCTable('sale_saleagent')]
    [MVCEntityActions([eaRetrieve, eaCreate, eaUpdate, eaDelete])]
    TSale_SaleAgent = Class(TMVCActiveRecord)
    Private
        [MVCTableField('SaleAgentID', [foPrimaryKey])]
        FSaleAgentID: Int32;
    ...
    Public
        ...
        Property EmployeeID: Int32 Read FEmployeeID Write FEmployeeID;
