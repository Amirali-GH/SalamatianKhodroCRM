Unit Model.Organization.Employee;
...
Type
    TEmployeeStatus = (esActive, esInactive, esSuspended, esTerminated);

    [MVCNameCase(ncLowerCase)]
    [MVCTable('organization_employee')]
    [MVCEntityActions([eaRetrieve, eaCreate, eaUpdate, eaDelete])]
    TOrganization_Employee = Class(TMVCActiveRecord)
    Private
        [MVCTableField('EmployeeID', [foPrimaryKey, foAutoGenerated])]
        FEmployeeID: Integer;

        [MVCTableField('EmployeeRoleID')]
        FEmployeeRoleID: Integer;
        ...
        [MVCTableField('NationalCode')]
        FNationalCode: NullableString;

        [MVCTableField('BirthDate')]
        FBirthDate: NullableString;

        [MVCTableField('HireDate')]
        FHireDate: NullableString;
    ...
    Public
        ...
        Property EmployeeRoleID: Integer Read FEmployeeRoleID Write FEmployeeRoleID;
        Property FirstName: NullableString Read FFirstName Write FFirstName;
        Property LastName: String Read FLastName Write FLastName;
        Property NationalCode: NullableString Read FNationalCode Write FNationalCode;
        Property BirthDate: NullableString Read FBirthDate Write FBirthDate;
        Property HireDate: NullableString Read FHireDate Write FHireDate;
