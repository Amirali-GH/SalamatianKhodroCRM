...
Type
    ...
    [MVCTable('car_category')]
    [MVCEntityActions([eaRetrieve, eaCreate, eaUpdate, eaDelete])]
    TCar_Category = Class(TMVCActiveRecord)
    Private
        [MVCTableField('CategoryID', [foPrimaryKey, foAutoGenerated, foReadOnly])]
        FCategoryID: Int32;
    ...
    Public
        Property CategoryID: Int32 Read FCategoryID Write FCategoryID;
