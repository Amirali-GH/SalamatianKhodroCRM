...
Begin
    ...
    Try
        Try
            ...
            LCarList := ACarService.GetAllCars(LCurrPage, LStatus, LContext);
                          ...
                          .Add('data', LCarList,
                              ...
                              Begin
                                  Links.AddRefLink
                                        ...
                                        .Add(HATEOAS.HREF, Format(BASE_API_V1 + '/car/%d', [TCar_Car(Obj).CarID]))
            ...
            Try
                ...
                Except
                    ...
                    Begin
                        ...
                        Begin
                            LStatusCode := HTTP_STATUS.Conflict;
                            Raise EMVCException.Create('کد ماشین تکراری است')
                        End
                        Else
                        Begin
                            Raise EMVCException.Create('خطای پایگاه داده: ' + E.Message);
