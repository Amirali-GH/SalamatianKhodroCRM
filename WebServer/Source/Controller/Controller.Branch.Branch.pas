...
Begin
    ...
    Try
        Try
            ...
            LBranchList := ABranchService.GetAllBranches(LCurrPage, LStatus, LContext);
                          ...
                          .Add('data', LBranchList,
                              ...
                              Begin
                                  Links.AddRefLink
                                        ...
                                        .Add(HATEOAS.HREF, Format(BASE_API_V1 + '/branch/%d', [TBranch(Obj).BranchID]))
...
Begin
    ...
    Begin
        Render(HTTP_STATUS.Ok, ABranchService.GetInfo(ABranchID.ToInteger));
    End
    Else
    Begin
