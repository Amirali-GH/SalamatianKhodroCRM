...
Function TCarCategoryService.GetAllCarCategories(Var APage: String; Const AStatus: String; Const AContext: String): TObjectList<TCar_Category>;
Var
    LCurrPage: Integer;
    LFirstRec: Integer;
...
Begin
    ...
    Result := TMVCActiveRecord.Where<TCar_Category>(
