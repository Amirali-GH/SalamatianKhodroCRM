...
Begin
    ...
    Try
        ...
        Try
            ...
            LFDQuery.SQL.Text := 'CALL sp_contract_process_file(:p_ContractFileID)';  // Assuming a similar SP for contracts
            LFDQuery.ParamByName('p_ContractFileID').AsLargeInt := LFileUploadID;
