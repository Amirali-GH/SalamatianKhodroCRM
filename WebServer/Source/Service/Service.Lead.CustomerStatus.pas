...
Function TCustomerStatusService.GetAllCustomerStatuses(Var APage: String; Const AStatus: String;
  Const AContext: String): TObjectList<TLead_CustomerStatus>;
Var
    LCurrPage: Integer;
    LFirstRec: Integer;
...
Begin
    ...
    Result := TMVCActiveRecord.Where<TLead_CustomerStatus>(
