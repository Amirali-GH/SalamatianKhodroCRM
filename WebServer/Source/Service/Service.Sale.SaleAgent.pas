...
Type
   TSaleAgentService = Class(TInterfacedObject, ISaleAgentService)
     Public
       Function GetAllSaleAgents(Var APage: String; Const AStatus: String; Const AContext: String; Const ABranchID: String): TObjectList<TSale_SaleAgent>;
...
Function TSaleAgentService.GetAllSaleAgents(Var APage: String; Const AStatus: String; Const AContext: String; Const ABranchID: String): TObjectList<TSale_SaleAgent>;
Var
