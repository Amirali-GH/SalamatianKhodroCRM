...
class function TDateUtils.FullDigitConvert(Alpha: string): string;
begin
  Result := Trim(Alpha) + ' ';
end;
class function TDateUtils.ConvertToPersianAlpha(Number: integer): string;
var
  sStr: string;
  sOutput: string;
  iCounter: Integer;
...
class function TDateUtils.IntGetRawDate(const Date: string): string;
var
  sTemp: string;
begin
  sTemp := '';
...
class function TDateUtils.IntGetDateWithDiv(Date: string; Divider: string): string;
var
  sTemp: string;
begin
  sTemp := '';
...
class function TDateUtils.CheckPrevChar(MainString: string; Index: integer; Char: string): boolean;
begin
...
class function TDateUtils.CountsSeparator(MainString: string): integer;
var
  iCounter: integer;
  iSlash: integer;
begin
...
class procedure TDateUtils.SeparateParts(ADate: string; var YPart, MPart, DPart: string; ADateKind: TDateKind);
var
  sTemp: string;
  dTemp: TDateTime;
...
class function TDateUtils.MiladiDate(ADate: TDate): string;
var
...
class function TDateUtils.MiladiFormat: string;
begin
//  Result := 'yyyy/mm/dd';
...
class function TDateUtils.MonthValidityCheck(Month: string): boolean;
begin
  Result := false;
...
class function TDateUtils.ConcatenateDate(AYear, AMonth, ADay: Word; ADateKind: TDateKind): String;
var
  lY, lM, lD: string;
begin
  lY := IntToStr(AYear);
...
class procedure TDateUtils.SeparateYMD(ADate: string; var Year, Month, Day: word; ADateKind: TDateKind);
var
  sTemp: String;
  dTemp: TDateTime;
begin
...
class function TDateUtils.SolarToGregorian(ASolarDate: string): string;
var
  dYear, dMonth, dDay: word;
begin
...
class function TDateUtils.GetWeekOfTheYear(ADate: string; DateKind: TDateKind): word;
var
  Year, Month, Day: word;
  iSum: integer;
  iCounter: integer;
...
class function TDateUtils.IncYear(ADate: string; DateKind: TDateKind; ANumberOfYear: integer = 1): string;
var
  Year, Month, Day: word;
begin
  SeparateYMD(ADate, Year, Month, Day, DateKind);
...
class function TDateUtils.IncMonth(ADate: string; DateKind: TDateKind; ANumberOfMonth: integer = 1): string;
var
  Year, Month, Day: word;
begin
  SeparateYMD(ADate, Year, Month, Day, DateKind);
...
class function TDateUtils.IncDay(ADate: string; DateKind: TDateKind; ANumberOfDay: integer = 1): string;
var
  Year, Month, Day: word;
begin
  SeparateYMD(ADate, Year, Month, Day, DateKind);
...
class function TDateUtils.DecYear(ADate: string; DateKind: TDateKind; ANumberOfYear: integer = 1): string;
var
  Year, Month, Day: word;
begin
  SeparateYMD(ADate, Year, Month, Day, DateKind);
...
class function TDateUtils.DecMonth(ADate: string; DateKind: TDateKind; ANumberOfMonth: integer = 1): string;
var
  Year, Month, Day: word;
  lMonth: integer;
begin
...
class function TDateUtils.DecDay(ADate: string; DateKind: TDateKind; ANumberOfDay: integer = 1): string;
var
  Year, Month, Day: word;
  TS: TTimeStamp;
  TempTime: Comp;
...
class function TDateUtils.GotoYear(ADate: string; AYear: integer; DateKind: TDateKind): string;
var
  Year, Month, Day: word;
begin
  SeparateYMD(ADate, Year, Month, Day, DateKind);
...
class function TDateUtils.GregorianToSolar(AMiladiDate: string): string;
var
  dYear, dMonth, dDay: word;
begin
...
class function TDateUtils.GregorianToSolar(ADate: TDate): string;
var
  dYear, dMonth, dDay: word;
begin
  DecodeDate(ADate, dYear, dMonth, dDay);
...
class function TDateUtils.FillDate(ADateKind: TDateKind): string;
begin
  if ADateKind = dkSolar then
...
class function TDateUtils.FixGregorianDate(ADate: string): string;
var
  date: TDateTime;
begin
  result := ADate;
...
class function TDateUtils.GotoMonth(ADate: string; AMonth: byte; DateKind: TDateKind): string;
var
  Year, Month, Day: word;
begin
  SeparateYMD(ADate, Year, Month, Day, DateKind);
...
class function TDateUtils.GotoDay(ADate: string; ADay: byte; DateKind: TDateKind): string;
var
  Year, Month, Day: word;
begin
  SeparateYMD(ADate, Year, Month, Day, DateKind);
...
class procedure TDateUtils.ResetYMD(Date: string; var Year, Month, Day: word; ADateKind: TDateKind);
begin
...
class function TDateUtils.IsLeapYear(DateKind: TDateKind; Year: Word): Boolean;
begin
  if DateKind = dkSolar then
...
class function TDateUtils.DaysOfMonth(DateKind: TDateKind; Year, Month: Word): Word;
begin
...
class function TDateUtils.IsDateValid(DateKind: TDateKind; Year, Month, Day: Word): Boolean;
begin
  Result := (Year <> 0) and (Month >= 1) and (Month <= 12) and
            (Day >= 1) and (Day <= DaysOfMonth(DateKind, Year, Month));
end;
class function TDateUtils.IsDateValid(DateKind: TDateKind; ADate: string): Boolean;
var
  wYear: word;
  wMonth: word;
  wDay: word;
...
class function TDateUtils.DaysToDate(DateKind: TDateKind; Year, Month, Day: Word): Word;
begin
...
class function TDateUtils.DateOfDay(DateKind: TDateKind; Days, Year: Word; var Month, Day: Word): Boolean;
var
  LeapDay, m: Integer;
begin
  LeapDay := 0;
...
class function TDateUtils.GregorianToSolar(var Year, Month, Day: Word): Boolean;
var
...
class function TDateUtils.SolarToGregorian(var Year, Month, Day: Word): Boolean;
var
...
class function TDateUtils.IntGetWeekRemainDays(Date: string; DateKind: TDateKind): integer;
var
...
class function TDateUtils.IntGetYearRemainDays(Date: string; DateKind: TDateKind): integer;
var
  Year, Month, Day, TempDay: Word;
...
class function TDateUtils.IntDayOfWeek(Date: string; DateKind: TDateKind): integer;
var
  Year, Month, Day: Word;
begin
  SeparateYMD(Date, Year, Month, Day, DateKind);
...
class function TDateUtils.IntGetMonthRemainDay(Date: string; DateKind: TDateKind): integer;
var
  Year, Month, Day: Word;
begin
  SeparateYMD(Date, Year, Month, Day, DateKind);
...
class function TDateUtils.ConvertDate(ADate: string; DateKind: TDateKind): string;
var
  Year, Month, Day: word;
begin
  SeparateYMD(ADate, Year, Month, Day, DateKind);
...
class function TDateUtils.ConvertYear(ADate: string; DateKind: TDateKind): integer;
var
  Year, Month, Day: word;
begin
  SeparateYMD(ADate, Year, Month, Day, DateKind);
...
class function TDateUtils.ConvertMonth(ADate: string; DateKind: TDateKind): integer;
var
  Year, Month, Day: word;
begin
  SeparateYMD(ADate, Year, Month, Day, DateKind);
...
class function TDateUtils.DaysBetween(ANow, AThen: string; DateKind: TDateKind): integer;
var
  Year, Month, Day: word;
